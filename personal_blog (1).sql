...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2022 at 07:30 AM
...
(26, 'tes', '2022-04-05 07:43:21', '2022-04-05 07:43:21'),
(27, 'smartphone', '2022-04-05 07:43:45', '2022-04-05 07:43:45');
...
INSERT INTO `order` (`id_order`, `id_produk`, `invoice_id`, `pelanggan`, `jumlah`, `total`, `status`, `created_at`, `updated_at`) VALUES
(1, 44, 321, 'risqi', 5, '10000', 'sent', '2022-04-05 14:45:13', '2022-04-05 14:45:13');
...
(44, 'Black Dickies Jacket', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc at luctus libero. Mauris vel tortor sit amet odio volutpat maximus sit amet sed dui. Aliquam velit odio, mattis eu ligula eget, laoreet egestas ex. Pellentesque rutrum pharetra erat, ac fermentum nibh convallis at. Sed quis vehicula purus. Pellentesque non nisl aliquet, condimentum leo ac, placerat mauris. Sed dui enim, convallis a vestibulum imperdiet, fermentum eu justo. Nunc eu fermentum mi. Curabitur ullamcorper pulvinar facilisis. Nunc in iaculis sem. Sed sodales dui sit amet suscipit tincidunt. Donec id quam diam.', 'Complete', '200000', '200', 0, '1648579584.png', '2022-03-29 11:46:24', '2022-03-29 11:46:24'),
...
--
ALTER TABLE `kategori`
  MODIFY `id_kategori` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `kategori1`
--
ALTER TABLE `kategori1`
  MODIFY `id_kategori1` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `kategori_produk`
--
ALTER TABLE `kategori_produk`
  MODIFY `id_kategori_produk` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
